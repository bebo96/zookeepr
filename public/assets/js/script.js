...
const handleAnimalFormSubmit = event => {
  ...
  // This will allow the request to make it to the proper endpoint in our server, which is the one we created in the previous lesson to add new animals to the JSON file.
